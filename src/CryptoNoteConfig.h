...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(81000000000);
...
const uint64_t DIFFICULTY_TARGET                             = 5000; // seconds
...
static_assert(2 * DIFFICULTY_CUT <= DIFFICULTY_WINDOW - 2, );
...
const char     CRYPTONOTE_NAME[]                             = "barancoin";
